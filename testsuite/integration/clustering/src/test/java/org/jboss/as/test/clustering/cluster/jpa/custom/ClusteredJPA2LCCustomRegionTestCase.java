...
public class ClusteredJPA2LCCustomRegionTestCase extends AbstractClusteringTestCase {
    ...
    void propsInCustomCache(@ArquillianResource @OperateOnDeployment(DEPLOYMENT_1) URL url0,
        ...
        assertEquals(99992, expirationLifespan.longValue(), String.format("Cache '%s' should have attribute expiration.lifespan=99992", regionName));

        // max_idle
        Long expirationMaxIdle = getExpirationMaxIdle(node0, regionName);
        assertEquals(99993, expirationMaxIdle.longValue(), String.format("Cache '%s' should have attribute expiration.maxIdle=99993", regionName));
