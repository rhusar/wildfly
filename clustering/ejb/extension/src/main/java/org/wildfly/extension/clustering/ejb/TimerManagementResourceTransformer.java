    ...
    public void accept(ModelVersion version) {
        if (DistributableEjbSubsystemModel.VERSION_2_0_0.requiresTransformation(version)) {
            this.builder.getAttributeBuilder()
                    .setDiscard(DiscardAttributeChecker.UNDEFINED, InfinispanTimerManagementResourceDefinitionRegistrar.MAX_IDLE)
                    .addRejectCheck(RejectAttributeChecker.DEFINED, InfinispanTimerManagementResourceDefinitionRegistrar.MAX_IDLE)
                    .end();
        }
    }
}
