...
public enum XMLAttribute {
    ...
    CLIENT_SSL_CONTEXT(SocketTransportResourceDefinition.Attribute.CLIENT_SSL_CONTEXT),
    SERVER_SSL_CONTEXT(SocketTransportResourceDefinition.Attribute.SERVER_SSL_CONTEXT),
